...
-   [formatFieldsForSortByOrder](#formatfieldsforsortbyorder)
-   [meta](#meta)
-   [og](#og)
...
-   [errorHtml](#errorhtml)
-   [errorInlineHtml](#errorinlinehtml)
...
-   `siteUrl` **[string](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String)** Site base URL.
...
-   `node` **[string](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String)** 
