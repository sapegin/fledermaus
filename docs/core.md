...
-   [parsePage](#parsepage)
-   [getSourceFilesList](#getsourcefileslist)
-   [loadSourceFiles](#loadsourcefiles)
-   [getConfigFilesList](#getconfigfileslist)
...
-   [getPageNumberUrl](#getpagenumberurl)
-   [paginate](#paginate)
...
-   `renderers` **[object](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)** {ext: renderFunction} (optional, default `{}`)
...
-   `$2` **[Object](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)**  (optional, default `{}`)
    -   `$2.renderers` **[object](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)** Content renderers: {ext: renderFunction}. (optional, default `{}`)
    -   `$2.fieldParsers` **[object](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)** Custom field parsers: {name: parseFunction}. (optional, default `{}`)
...
-   `$1` **[Object](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)**  (optional, default `{}`)
    ...
    -   `$1.extra` **[object](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)** Extra document options. (optional, default `{}`)
